...
xst -ifn xst.scr
move clockManager_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clockManager_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clockManager_exdes.ucf clockManager_exdes

echo 'Running map'
map -timing -pr b clockManager_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clockManager_exdes -w routed.ncd routed.v
cd ..
